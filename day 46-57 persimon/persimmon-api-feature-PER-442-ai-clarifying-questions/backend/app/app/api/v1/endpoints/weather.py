...
async def get_weather_sync_work_by_city(city: str = "Quito") -> GetResponseBase:
    """
...
async def get_weather_sync_client_by_city(city: str = "Quito") -> GetResponseBase:
    """
...
async def get_weather_async_client_by_city(city: str = "Quito") -> GetResponseBase:
    """
