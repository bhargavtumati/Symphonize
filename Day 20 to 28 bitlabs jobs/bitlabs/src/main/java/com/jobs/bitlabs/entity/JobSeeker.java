...
public class JobSeeker {
    ...
    private Map<CompanyJob, JobStatus> appliedJobStatus = new HashMap<>();
	...
	public JobSeeker(Long id, String name, String email, String whatsappnumber,
			...
			Set<Skills> skills, byte[] profileImage, byte[] resume, Map<CompanyJob, JobStatus> appliedJobStatus) {
		super();
		this.id = id;
		this.name = name;
		this.email = email;
	...
	public Map<CompanyJob, JobStatus> getAppliedJobStatus() {
		return appliedJobStatus;
	}

	public void setAppliedJobStatus(Map<CompanyJob, JobStatus> appliedJobStatus) {
		this.appliedJobStatus = appliedJobStatus;
	}
