...
import com.jobs.bitlabs.exception.Response;
...
public class CompanyProfileController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Company Profile updated",
                    content = @Content(schema = @Schema(implementation = CompanyProfileDto.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Company Profile deleted"),
            @ApiResponse(responseCode = "404", description = "Company Profile not found")
    })
    @DeleteMapping("/deleteById")
    public ResponseEntity<String> deleteCompanyProfile(@RequestParam String companyId) {
