...
export default function SendGridIntegrations() {
  ...
  useEffect(() => {
    const checkVerifyStatus = async (name: string) => {
      ...
      checkVerifyStatus("sendgrid")
  }, [])
  const handleSendGridIntegration = async (apikey: string, name: string) => {
    try {
      ...
      toast({
        variant: "default",
        title: "Success",
        description: "SendGrid integration successful",
        duration: 2000,
      })
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    handleSendGridIntegration(apikey, "sendgrid")
  }
  ...
  if (verifyStatus) {
    return (
      <IntegrationStatus
        imageSrc="/images/sendgrid.svg"
        description="Manage your SendGrid connection to send emails seamlessly."
        editPath="/integrations/sendGrid-integrations"
        handleEditClick={() => {
          setVerifyStatus(false)
          handleGetKey("sendgrid")
        }}
      />
    );
  }
    ...
    <Card className="my-8 max-w-4xl p-2 cursor-pointer" >
      <CardHeader>
        ...
        <CardDescription className="text-base text-slate-500 space-x-2">
         Connect your SendGrid account to send emails seamlessly within Persimmon
        </CardDescription>
        <CardContent className="space-y-4 p-0">
          <div>
            <div className="flex items-center space-x-2 mt-3">
              <Image src={"/images/sendgrid.svg"} height={24} width={140} alt={"SendGrid logo"} />
              <ArrowLeftRight strokeWidth={2} className="mt-2" />
            ...
            <div className="p-6">
              <StepInstruction
                ...
                imageSrc={"/images/sendgrid-step1.png"}
              />
              <div className="space-x-2 pt-6">
                <StepInstruction
                  ...
                  description={
                    <span>
                      Click on settings and then click on <span className="text-base font-bold">API keys </span>
                    </span>
                  }
                  imageSrc={"/images/sendgrid-step2.png"}
                />
              </div>
              <div className="space-x-2 pt-6">
                <StepInstruction
                  ...
                  description={
                    <span>
                      Then click on <span className="text-base font-bold">Create API Key</span>
                    </span>
                  }
                  imageSrc={"/images/sendgrid-step3.png"}
                />
              </div>
              <div className="space-x-2 pt-6">
                <StepInstruction
                  ...
                  description={
                    <span>
                      ...
                      Give a name and select the permissions and then click on <span className="text-base font-bold">Create & View</span>
                    </span>
                  }
                  imageSrc={"/images/sendgrid-step4.png"}
                />
              </div>
                ...
                <StepInstruction
                  ...
                  description={
                    <span>
                      ...
                      Copy the <span className="text-base font-bold">API key</span> and save it
                    </span>
                  }
                  imageSrc={"/images/sendgrid-step5.png"}
                />
              </div>
              <div className="space-x-12 pt-6">
                <StepInstruction
                  stepNumber={6}
