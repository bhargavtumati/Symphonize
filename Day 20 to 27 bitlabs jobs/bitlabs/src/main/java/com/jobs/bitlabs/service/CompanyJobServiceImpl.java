...
public class CompanyJobServiceImpl implements CompanyJobService {
	...
	public String changeJobSeekerJobStatus(String companyjobid, Long id, String changedstatus) {
        ...
        Map<JobSeeker,String> companyjobmap = companyjob.getApplicantStatus();
		
		for (Map.Entry<JobSeeker, String> entry : companyjobmap.entrySet()) {
	...
	public List<JobSeeker> FilterData(Long Experience, String companyjobid) throws IOException{
        ...
        Map<JobSeeker,String> applicantsmap = companyjob.getApplicantStatus();
		
		for (Map.Entry<JobSeeker, String> entry : applicantsmap.entrySet()) {
